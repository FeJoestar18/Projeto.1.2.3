...
<head>
    ...
    width: 420px;
    padding-top: 25px; /* Ajusta o padding */
    margin-top: -50px; /* Adiciona um espaço negativo */
}
...
<body>
    ...
    <div class="login-container">
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            $telefone = mysqli_real_escape_string($conn, $_POST['telefone']); // Novo campo telefone
            ...
            if ($stmt_check->num_rows > 0) {
                ...
                $sql_insert = "INSERT INTO pessoa (nome, email, senha, cpf, telefone) VALUES (?, ?, ?, ?, ?)"; // Adicionando telefone
                $stmt_insert = $conn->prepare($sql_insert);
                $stmt_insert->bind_param("sssss", $nome, $email, $senha_hashed, $cpf, $telefone); // Adicionando telefone
        ...
        <form action="" method="POST">
            ...
            <input type="text" placeholder="Telefone" name="telefone" required pattern="\d{10,11}"required maxlength="11" reqtitle="O telefone deve conter 10 ou 11 dígitos."> <!-- Novo campo telefone -->
